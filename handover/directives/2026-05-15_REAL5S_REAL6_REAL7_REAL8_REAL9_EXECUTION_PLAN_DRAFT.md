...
Status: DRAFT after R1 VETO remediation. This file must be reviewed by an independent clean-context Codex agent before user approval and before any `turingos_dev` implementation run.
