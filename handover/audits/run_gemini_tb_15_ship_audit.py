...
ENV_FILES = [ROOT / ".env"]
ROUND = os.environ.get("TB15_AUDIT_ROUND", "R1")
...
# ── Brief ──
brief = """# Gemini TB-15 Ship Audit — Lamarckian Autopsy + Markov EvidenceCapsule (Class 2 envelope, retroactive dual audit, architectural strategic review)
