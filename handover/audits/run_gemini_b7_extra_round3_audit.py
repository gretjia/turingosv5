#!/usr/bin/env python3
"""Gemini ROUND-3 RE-AUDIT — Phase B B7-extra after dual-VETO fixes.
...
brief = """# Gemini ROUND-3 RE-AUDIT — Phase B B7-extra (after VETO fixes)
...
**Decision rule**:
- If round-2 fix resolves Codex's defect AND introduces no new P0 AND your prior VETO items (Q2.b, Q2.e) remain resolved AND your prior PASS items are not regressed: **PASS** with HIGH conviction → batch authorized.
